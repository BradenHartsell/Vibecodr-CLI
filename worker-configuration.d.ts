/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8a25fc05594717f7991fe52094a7b24)
// Runtime types generated with workerd@1.20260515.1 2026-05-11 nodejs_compat
interface __BaseEnv_Env {
	...
	VC_TOOLS_PROVIDER_MODE: "live";
	VC_TOOLS_PLAN_NAME: "Creator";
	VC_TOOLS_HOSTED_ACCOUNT_SOFT_CAP: "24";
	VC_TOOLS_HOSTED_ACCOUNT_HARD_CAP: "30";
	VC_TOOLS_BROWSER_RUN_ACCOUNT_SOFT_CAP: "24";
	VC_TOOLS_BROWSER_RUN_ACCOUNT_HARD_CAP: "30";
	VC_TOOLS_SANDBOX_ACCOUNT_SOFT_CAP: "24";
	VC_TOOLS_SANDBOX_ACCOUNT_HARD_CAP: "30";
	VC_TOOLS_CLOUDFLARE_SPEND_SOFT_USD: "80";
	VC_TOOLS_CLOUDFLARE_SPEND_HARD_USD: "100";
	VC_TOOLS_INTERNAL_METADATA_ACTOR_IDS: "user_35SPbxey6To5mdYhdvgb3cBsMQ5";
	Sandbox: DurableObjectNamespace<import("./src/hosted/worker").Sandbox>;
	ProSandbox: DurableObjectNamespace<import("./src/hosted/worker").ProSandbox>;
	VC_TOOLS_INTERNAL_API_WORKER: Fetcher /* vibecodr-internal-api */;
	BROWSER_AGENT_WORKFLOW: Workflow<Parameters<import("./src/hosted/worker").BrowserAgentTaskWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/hosted/worker");
		durableNamespaces: "Sandbox" | "ProSandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VC_TOOLS_PUBLIC_BASE_URL" | "VC_TOOLS_BROWSER_HANDOFF_UI_BASE_URL" | "VC_TOOLS_PROVIDER_MODE" | "VC_TOOLS_PLAN_NAME" | "VC_TOOLS_HOSTED_ACCOUNT_SOFT_CAP" | "VC_TOOLS_HOSTED_ACCOUNT_HARD_CAP" | "VC_TOOLS_BROWSER_RUN_ACCOUNT_SOFT_CAP" | "VC_TOOLS_BROWSER_RUN_ACCOUNT_HARD_CAP" | "VC_TOOLS_SANDBOX_ACCOUNT_SOFT_CAP" | "VC_TOOLS_SANDBOX_ACCOUNT_HARD_CAP" | "VC_TOOLS_CLOUDFLARE_SPEND_SOFT_USD" | "VC_TOOLS_CLOUDFLARE_SPEND_HARD_USD" | "VC_TOOLS_INTERNAL_METADATA_ACTOR_IDS">> {}
}
