...
export const CAPABILITY_ALIASES: Record<string, CapabilityName> = {
  ...
  "browser.session_open": "browser.session_open",
  "browser.session.observe": "browser.session_observe",
  "browser.session_observe": "browser.session_observe",
  "browser.session.goto": "browser.session_navigate",
  "browser.session.navigate": "browser.session_navigate",
  "browser.session_navigate": "browser.session_navigate",
  "browser.session.click": "browser.session_click",
  "browser.session_click": "browser.session_click",
  "browser.session.type": "browser.session_type",
  "browser.session_type": "browser.session_type",
  "browser.session.scroll": "browser.session_scroll",
  "browser.session_scroll": "browser.session_scroll",
  "browser.session.wait": "browser.session_wait",
  "browser.session_wait": "browser.session_wait",
  "browser.session.auth": "browser.session_auth_request",
  "browser.session.auth.request": "browser.session_auth_request",
  "browser.session_auth_request": "browser.session_auth_request",
  "browser.session.auth.status": "browser.session_auth_status",
  "browser.session_auth_status": "browser.session_auth_status",
  "browser.session.auth.complete": "browser.session_auth_complete",
  "browser.session_auth_complete": "browser.session_auth_complete",
  "browser.session.auth.revoke": "browser.session_auth_revoke",
  "browser.session_auth_revoke": "browser.session_auth_revoke",
  "browser.session.close": "browser.session_close",
  "browser.session_close": "browser.session_close",
...
export const DEFAULT_PLANS = [
  ...
  },
  {
    ...
    posture: {
      authenticatedBrowsing: "human-handoff-beta",
      browserRecording: "disabled",
  ...
  },
  {
    ...
    posture: {
      authenticatedBrowsing: "human-handoff-allowlisted-beta",
...
export const PUBLIC_OFFERING_CLASSIFICATIONS = [
  ...
  },
  {
    ...
    status: "gated beta",
    summary: "Paid Agent Browser sessions with open, observe, action, live human takeover, and close controls over a hosted public-HTTPS browser."
  },
  {
...
export const LAUNCH_TOOL_GRANTS = [
  ...
  { grant: "browser.session.open", capability: "browser.session_open", defaultScope: "project", phase: "paid-workflows", allowedPlans: ["Creator", "Pro"] },
  { grant: "browser.session.observe", capability: "browser.session_observe", defaultScope: "project", phase: "paid-workflows", allowedPlans: ["Creator", "Pro"] },
  { grant: "browser.session.navigate", capability: "browser.session_navigate", defaultScope: "project", phase: "paid-workflows", allowedPlans: ["Creator", "Pro"] },
  { grant: "browser.session.click", capability: "browser.session_click", defaultScope: "project", phase: "paid-workflows", allowedPlans: ["Creator", "Pro"] },
  { grant: "browser.session.type", capability: "browser.session_type", defaultScope: "project", phase: "paid-workflows", allowedPlans: ["Creator", "Pro"] },
  { grant: "browser.session.scroll", capability: "browser.session_scroll", defaultScope: "project", phase: "paid-workflows", allowedPlans: ["Creator", "Pro"] },
  { grant: "browser.session.wait", capability: "browser.session_wait", defaultScope: "project", phase: "paid-workflows", allowedPlans: ["Creator", "Pro"] },
  { grant: "browser.session.auth.request", capability: "browser.session_auth_request", defaultScope: "user", phase: "paid-workflows", allowedPlans: ["Creator", "Pro"] },
  { grant: "browser.session.auth.status", capability: "browser.session_auth_status", defaultScope: "user", phase: "included", allowedPlans: ["Free", "Creator", "Pro"] },
  { grant: "browser.session.auth.complete", capability: "browser.session_auth_complete", defaultScope: "user", phase: "included", allowedPlans: ["Free", "Creator", "Pro"] },
  { grant: "browser.session.auth.revoke", capability: "browser.session_auth_revoke", defaultScope: "user", phase: "included", allowedPlans: ["Free", "Creator", "Pro"] },
  { grant: "browser.session.close", capability: "browser.session_close", defaultScope: "project", phase: "included", allowedPlans: ["Free", "Creator", "Pro"] },
